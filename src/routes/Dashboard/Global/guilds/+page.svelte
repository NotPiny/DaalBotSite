<script>
    ...
    /**
     * @type {Array<{name: string, id: string, icon: string, owner: string, memberCount: number}>}
     */
    let guilds = [];
    ...
    <div class="guilds">
        {#each guilds as guild}
            <sl-card>
                ...
                <span><img src={crownSVG} alt="Crown Icon" style="height: 15px; width: 15px;"/> <b>{guild.owner}</b></span><br />
