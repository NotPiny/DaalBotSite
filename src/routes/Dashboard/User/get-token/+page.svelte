    ...
    */
    async function returnData(allow) {
        ...
        if (returnURL?.href === 'https://daalbot.xyz/show') {
            ...
            window.location.href = `${returnURL?.href}?accesscode=${allow ? localStorage.getItem('accesscode') : 'denied'}&guild=none`
        }
    }
</script>
...
<main>
    ...
    <p class="small"><a href="https://docs.daalbot.xyz/api#auth">Learn More</a></p>
</main>
